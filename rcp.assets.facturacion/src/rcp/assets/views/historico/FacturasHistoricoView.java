package rcp.assets.views.historico;
...
public class FacturasHistoricoView extends AbstractViewPart {
	...
	//public static final String ID = "rcp.assets.views.FacturasView"; //$NON-NLS-1$
		...
		public void refrescar() {
			viewer.setInput(controller.getFacturasInactivas());
			viewer.refresh();
		}
